# Task Manager App (Taskify)

A beautiful and functional **Task Management Application** with real-time synchronization.
...
[View Live Demo](https://task-manager-app-two-liart.vercel.app/)
